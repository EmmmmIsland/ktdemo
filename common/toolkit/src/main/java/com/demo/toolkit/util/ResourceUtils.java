...
public class ResourceUtils {
    ...
    public static String getResourceUri(@DrawableRes int resId) {
        Resources resources = getContext().getResources();
        return Uri.parse(String.format("%s://%s/%s/%s", ContentResolver.SCHEME_ANDROID_RESOURCE, resources.getResourcePackageName(resId), resources.getResourceTypeName(resId), resources.getResourceEntryName(resId))).toString();
    }
