...
public abstract class NestedLifecycleFragment extends Fragment {
    ...
    private void enqueueDispatchVisible() {
        getHandler().post(() -> dispatchChildVisibleState(true));
    }
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof NestedLifecycleFragment) {
            NestedLifecycleFragment fragment = (NestedLifecycleFragment) parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (!fragments.isEmpty()) {
            for (Fragment child : fragments) {
                if (child instanceof NestedLifecycleFragment && child.isAdded() && !child.isHidden() && child.getUserVisibleHint()) {
                    ((NestedLifecycleFragment) child).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
